...
$sql_common = " from {$g5['hash_tag_table']} a, {$g5['board_table']} b, {$g5['group_table']} c where a.bo_table = b.bo_table and b.gr_id = c.gr_id and a.name='$q' ";

$sql_order = " order by a.id desc ";

$sql = " SELECT count(*) AS cnt  FROM {$g5['hash_tag_table']} a WHERE a.name='$q' ";
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
include_once($tags_skin_path.'/tags.skin.php');
